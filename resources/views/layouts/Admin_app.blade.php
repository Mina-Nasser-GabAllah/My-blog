        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('User.Index')}}"><i class="fa fa-users fa-fw"></i> Users Display</a>
                    </li>
                    <li>
                        <a href="{{route('Section.Index')}}"><i class="fa fa-th fa-fw"></i> Section Display</a>
                    </li>

                    @endif

                    <li>
                        <a href="{{route('Image.Index')}}"><i class="fa fa-photo fa-fw"></i> Image Display</a>
                    </li>

                    <li>
                        <a href="{{route('Post.Index')}}"><i class="fa fa-building-o fa-fw"></i> Post Display</a>
                    </li>
